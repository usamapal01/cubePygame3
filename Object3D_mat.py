...
class Object3D:
    ...
    def projection_matrix_update(self, frustum):
    ...
    def view_matrix_update(self, camera):
        ...
        self.view_matrix = numpy.linalg.inv(a_camera)

    def model_matrix_update(self):
        # scale
    ...
    def local_to_world(self, local_vertex: numpy.array, model_matrix) -> numpy.array:
        ...
        # local_vertex = numpy.matmul(model_matrix, local_vertex)
        # return local_vertex

        return numpy.matmul(model_matrix, local_vertex)

    def world_to_view(self, world_vertex, view_matrix) -> numpy.array:
        """
        ...
        # world_vertex = numpy.matmul(view_matrix, world_vertex)
        # return world_vertex

        return numpy.matmul(view_matrix, world_vertex)

    def view_to_clip(self, view_vertex, projection_matrix) -> numpy.array:
        """
        ...
        view_vertex = numpy.matmul(projection_matrix, view_vertex)

        view_vertex = numpy.array([view_vertex[0] / view_vertex[3],
                                   view_vertex[1] / view_vertex[3], view_vertex[2], view_vertex[3]])
        return view_vertex
